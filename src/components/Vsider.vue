...
#vsider
  el-row.tac
        ...
        el-menu(unique-opened=true, router=true, @open='handleOpen', @close='handleClose', background-color="#324157", text-color="#fff")
          el-submenu(index='/info')
            ...
            el-menu-item-group(title='文章')
              ...
              el-menu-item(index='/posts?q=markting') 业界快讯
          ...
          el-submenu(index='/app')
            ...
            el-menu-item-group(title='IF Talk')
              ...
              el-menu-item(index='/audios') 音频列表
    ...
    template(v-else-if="$store.state.roles === 'partner'")
      el-col(:span='8')
        el-menu(unique-opened=true, router=true, @open='handleOpen', @close='handleClose', background-color="#324157", text-color="#fff", :default-openeds='openeds')
          el-submenu(index='0')
            template(slot='title')
              img(src='../assets/imgs/sider_info.svg')
              span 资讯
            el-menu-item-group(title='资讯')
              //- el-menu-item(index='/soft/new') 添加资讯
              el-menu-item(index='/soft') 业界快讯
</template>
